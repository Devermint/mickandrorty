...
function AgentLayoutMobile(activeAgent : Agent) {
    return (
        <Flex paddingLeft="2rem" paddingRight="2rem" height="60vh" direction="column">
            <Box marginLeft="2rem" marginRight="2rem" position="relative" alignItems="center" height="40%">
                <Grid blur="5px" filter="auto" height="100%" width="100%" templateRows="repeat(5, 1fr)" templateColumns="repeat(5, 1fr)" gap="0.5rem">
                    <GridItem>
                        <GridBox>
                            <Box justifyItems="center" alignContent="center" height="100%">
                                <Text fontWeight="400" fontSize="14px" lineHeight="21px">SOCIAL GRAPH</Text>
                            </Box>
                        </GridBox>
                    </GridItem>
                    <GridItem colSpan={2}>
                        <GridBox>
                            <Text fontWeight="700" fontSize="17px" lineHeight="22px">302</Text>
                            <Text fontWeight="500" fontSize="8px" lineHeight="11px" color="#FFFFFF">Score</Text>
                        </GridBox>
                    </GridItem>
                    <GridItem colSpan={2}>
                        <GridBox>
                            <Text fontWeight="700" fontSize="17px" lineHeight="22px">30.32K</Text>
                            <Text fontWeight="500" fontSize="8px" lineHeight="11px" color="#FFFFFF">Followers</Text>
                        </GridBox>
                    </GridItem>
                    <GridItem colSpan={5} rowSpan={4}>
                        <AgentGraph />
