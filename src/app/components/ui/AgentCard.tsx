...
export default function AgentCard(agent: Agent) {
    return (
        <Container width="360px" height="508px" background="#000000" borderTopLeftRadius="100px" boxShadow="0px 0px 32px 0px #F9E0CC1A" padding="1.5rem">
            {/* Image */}
            ...
            <Flex marginTop="0.5rem" justify="space-between">
                ...
                <Flex gap="0.5rem">
                    <IconButton background="#042911">
                        <NextImage src="/socials/telegram.svg" alt="telegram" width="24" height="24" />
                    </IconButton>
                    <IconButton background="#042911">
                        <NextImage src="/socials/x.svg" alt="X" width="24" height="24" />
                    </IconButton>
                </Flex>
            </Flex>
